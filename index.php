...
<head>
  ...
  <link href="/Harmony-Nails/css/bootstrap.min.css" rel="stylesheet" type="text/css">
  <link href="/Harmony-Nails/css/harmonystyle.css" rel="stylesheet" type="text/css">
  <link rel=icon href=/Harmony-Nails/images/favicon.png type="image/png">
...
<body>
		...
		<div class="navbar-header-fluid">
			<nav class="navbar navbar-expand-md navbar-light rounded navbar-static-top" role="navigation">
				<a class="navbar-brand" href="index.php" style="font-family: Freestyle Script;">
					<img src="/Harmony-Nails/images/logo.svg" alt="Harmony Nails"/>
				</a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-1000 sombra" src="/Harmony-Nails/images/carousel_1.svg" alt="First slide">
        ...
        <div class="carousel-item">
          <img class="d-block w-1000 sombra" src="/Harmony-Nails/images/carousel_2.svg" alt="Second slide">
          <div class="carousel-caption d-none d-md-block">
            <h5>Contáctanos</h5>
        ...
        <div class="carousel-item">
          <img class="d-block w-1000 sombra" src="/Harmony-Nails/images/carousel_3.svg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
      ...
      <div class="container-fluid">
        ...
        <div id="VerMas" class="collapse">
          ...
          <h2><?php $value=5; $conn = new conexion(); $conn->recuperarDatos($value); ?></h2>
            <p class="p"><?php $value=5; $conn = new conexion(); $conn->recuperarContenido($value); ?></p>
        </div>
      </div>
    </article>
  </section>
  ...
  <!-- Librerias y scripts Javascript -->
	<script src="/Harmony-Nails/scripts/jquery-3.2.1.slim.min.js"></script>
	<script>window.jQuery || document.write('<script src="/Harmony-Nails/scripts/jquery-slim.min.js"><\/script>')</script>
	<script src="/Harmony-Nails/scripts/popper.min.js"></script>
	<script src="/Harmony-Nails/scripts/bootstrap.min.js"></script>
	<script src="/Harmony-Nails/scripts/Boton_Volver.js"></script>
</body>
</html>
